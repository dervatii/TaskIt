...
let kShouldCapitalizeTaskKey = "shouldCapitalizedTask"
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    //A managed object model is a model. Similar to the struct model we created for our tasks, this represents a record from a persistent store. A managed object is registered with one managed object context.
    ...
    //This is like a database connection. An app could have multiple stores of data. Most apps you will write will need just one store, particularly in the beginning. It is the job of the persistent store coordinator to manage which store the managed object context needs to pull from. For us, the persistent store coordinator will only be coordinating one store for the managed object context.
    ...
    //This funcion is for manage object context.. save, delete and so on. Allows you to create and fetch managed object models.
